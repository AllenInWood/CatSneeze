...
<head>
    ...
    <script src="../js/movieProfile.js"></script>
...
<div class="album py-5 bg-light">
    <div class="container">
        <div class="row" style="margin-bottom: 30px;">
            ...
            <div class="col-md-5">
                <%
                    MovieVo movieVo = (MovieVo) request.getAttribute(Const.CURRENT_MOVIE);
                %>
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <%
                            for (int i = 0; i < movieVo.getStarsList().size(); i++) {
                        %>
                        <a href="./star?id=<%=movieVo.getStarsList().get(i).getId()%>" class="card-link"><%=movieVo.getStarsList().get(i).getName()%></a>
                        <%
                            }
                        %>
                    </div>
