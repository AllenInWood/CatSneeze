...
<html>
<head>
    <title>Movies Modify</title>
    <%--<meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests">--%>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css">
    <script src="http://code.jquery.com/jquery-latest.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"></script>
    <script src="../../js/backstage/moviesModify.js"></script>
            ...
            <form class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="year" placeholder="XXXX" value="" required>
                        <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="director" placeholder="" value="">
                        <div class="invalid-feedback">
                            Valid last name is required.
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3"><h4>Genres:</h4></div>
                    <div class="col-md-6 mb-3"></div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3"><h4>Star Info:</h4></div>
                    <div class="col-md-6 mb-3"></div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <button class="btn btn-primary btn-lg btn-block insertMovie" type="button">Insert</button>
