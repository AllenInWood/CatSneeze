...
<head>
    ...
    <script src="js/moviesFulltextSearchResultList.js"></script>
    ...
    <div class="container">
        ...
        <div style="text-align: center; margin-bottom: 50px;">
            <%
                ...
                String pre5Movie = "./full-text?query=" + query + "&&limit=5&&offset=" + offset;
                String pre10Movie = "./full-text?query=" + query + "&&limit=10&&offset=" + offset;
                String pre20Movie = "./full-text?query=" + query + "&&limit=20&&offset=" + offset;
            %>
        ...
        <div class="row">
            <%
                List<MovieVo> movieVoList = (List<MovieVo>) request.getAttribute(Const.MOVIE_LIST);
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <%
                    ...
                    String prePage = "./full-text?query=" + query +  "&&limit=" + limit + "&&offset=" + preOffset;
                    String postPage = "./full-text?query=" + query + "&&limit=" + limit  + "&&offset=" + postOffset;
                    String ppostPage = "./full-text?query=" + query + "&&limit=" + limit  + "&&offset=" + ppostOffset;
